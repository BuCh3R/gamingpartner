...
<h3 id="teamup-link" class="h-headline2">Dota2 Partner</h3>
            ...
            <div class="float-right linkbox">
                    ...
                    <br>
                <a target="_blank" href="https://www.dotabuff.com/">dotabuff.com</a>
                <br>
                <a target="_blank" href="https://www.opendota.com/">opendota.com</a>
                <br>
                <a target="_blank" href="https://stratz.com/en-us/">stratz.com</a>
                <br>
                <a target="_blank" href="https://ggscore.com/en/dota-2/player">ggscore.com</a>
                </div>
            <?php
...
echo "<form method='POST' action='".setComments($conn)."'>
    <input class='bold' type='hidden' name='uid' value='Gæst(Dota2)'>
    <input class='bold' type='hidden' name='date' value='".date('Y-m-d H:i:s')."'>
    <div class='area-pos'><textarea name='message' placeholder='Skriv dit opslag her fx. server, ign, rank, lf...'></textarea></div><br>
    <button class='button-class delbut' type='submit' name='commentSubmit'>Del</button>
</form>";
...
function setComments($conn) {
    if(isset($_POST['commentSubmit'])){
        ...
        $sql = "INSERT INTO comments_dota2 (uid, date, message) VALUES ('$uid', '$date', '$message')"; 
...
function getComments($conn){
    $sql = "SELECT * FROM comments_dota2 ORDER BY cid DESC LIMIT 22";
    $result = $conn->query($sql);
