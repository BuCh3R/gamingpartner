...
<h3 id="teamup-link" class="h-headline2">Fortnite Partner</h3>
            ...
            <div class="float-right linkbox">
                    ...
                    <br>
                <a target="_blank" href="https://fortnitetracker.com/">fortnitetracker.com</a>
                <br>
                <a target="_blank" href="https://fortnitestats.com/">fortnitestats.com</a>
                <br>
                <a target="_blank" href="https://www.fortnitescout.com/">fortnitescout.com</a>
                <br>
                <a target="_blank" href="https://www.fortbuff.com/">fortbuff.com</a>
                </div>
            <?php
...
echo "<form method='POST' action='".setComments($conn)."'>
    <input class='bold' type='hidden' name='uid' value='Gæst(Fortnite)'>
    <input class='bold' type='hidden' name='date' value='".date('Y-m-d H:i:s')."'>
    <div class='area-pos'><textarea name='message' placeholder='Skriv dit opslag her fx. server, ign, rank, lf...'></textarea></div><br>
    <button class='button-class delbut' type='submit' name='commentSubmit'>Del</button>
</form>";
...
function setComments($conn) {
    if(isset($_POST['commentSubmit'])){
        ...
        $sql = "INSERT INTO comments_fn (uid, date, message) VALUES ('$uid', '$date', '$message')"; 
...
function getComments($conn){
    $sql = "SELECT * FROM comments_fn ORDER BY cid DESC LIMIT 22";
    $result = $conn->query($sql);
