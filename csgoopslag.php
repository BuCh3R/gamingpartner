...
<h3 id="teamup-link" class="h-headline2">CS:GO Partner</h3>
            ...
            <div class="float-right linkbox">
                    <p>Platform links:</p>
                    <br>
                <a target="_blank" href="https://www.faceit.com/">faceit.com</a>
                <br>
                <a target="_blank" href="https://play.esea.net/">esea.net</a>
                <br>
                <a target="_blank" href="https://cevo.com/">cevo.com</a>
                <br>
                <a target="_blank" href="https://www.challengeme.gg/">challengeme.gg</a>
                </div>
                <div class="float-right linkbox2">
                    <p>Kommende events:</p>
                    <br>
                    <a target="_blank" href="https://www.hltv.org/events">hltv.org/events</a>
                    <br>
...
echo "<form method='POST' action='".setComments($conn)."'>
    <input class='bold' type='hidden' name='uid' value='Gæst(CS:GO)'>
    <input class='bold' type='hidden' name='date' value='".date('Y-m-d H:i:s')."'>
    <div class='area-pos'><textarea name='message' placeholder='Skriv dit opslag her fx. server, ign, rank, lf...'></textarea></div><br>
    <button class='button-class delbut' type='submit' name='commentSubmit'>Del</button>
</form>";
...
function getComments($conn){
    $sql = "SELECT * FROM comments ORDER BY cid DESC LIMIT 22";
    $result = $conn->query($sql);
