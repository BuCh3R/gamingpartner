...
<h3 id="teamup-link" class="h-headline2">LoL Partner</h3>
            ...
            <body>
                <div class="float-right linkbox">
                    <p>Accounts stats links:</p>
                    <br>
                <a target="_blank" href="https://www.op.gg/">op.gg</a>
                <br>
                <a target="_blank" href="https://lolprofile.net/">lolprofile.net</a>
                <br>
                <a target="_blank" href="http://www.lolskill.net/">lolskill.net</a>
                <br>
                <a target="_blank" href="https://lol.mobalytics.gg/summoner-search">lol.mobalytics.gg</a>
                </div>
                <div class="float-right linkbox2">
                    <p>Kommende events:</p>
                    <br>
                    <a target="_blank" href="http://www.lanparty.dk/">lanparty.dk</a>
                    <br>
                    <a target="_blank" href="https://lol.gamepedia.com/Leaguepedia:Tournaments">lol.gamepedia.com</a>
                    <br>
                    <a target="_blank" href="https://eu.lolesports.com/en">eu.lolesports.com</a>
                </div>
...
echo "<form method='POST' action='".setComments($conn)."'>
    <input class='bold' type='hidden' name='uid' value='Gæst(LoL)'>
    <input class='bold' type='hidden' name='date' value='".date('Y-m-d H:i:s')."'>
    <div class='area-pos'><textarea name='message' placeholder='Skriv dit opslag her fx. server, ign, rank, lf...'></textarea></div><br>
    <button class='button-class delbut' type='submit' name='commentSubmit'>Del</button>
</form>";
...
function setComments($conn) {
    if(isset($_POST['commentSubmit'])){
        ...
        $sql = "INSERT INTO comments_lol (uid, date, message) VALUES ('$uid', '$date', '$message')"; 
...
function getComments($conn){
    $sql = "SELECT * FROM comments_lol ORDER BY cid DESC LIMIT 22";
    $result = $conn->query($sql);
